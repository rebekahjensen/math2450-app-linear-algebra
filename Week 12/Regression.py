...
de_y = y - np.average(y)
pearson = (de_predicted @ de_y) / (np.linalg.norm(de_predicted) * np.linalg.norm(de_y))
print("correlation = " + str(pearson), "\n")    
