...
X = np.column_stack([x[0]**2, x[1]**2, x[0]*x[1], x[0], x[1], np.ones(m)])
...
print("The area and number of bedrooms affects the price of the house.")
print("Model 4.3.2 only uses the area to see, while the other model uses multiple features to see")
print("I would say that the other model is a better way to look at it because there are more factors that change the price of the house, area alone is not enough.")