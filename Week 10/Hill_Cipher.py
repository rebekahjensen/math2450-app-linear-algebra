#hillcipher using numpy

import numpy as np

#convert plain English into a list of vector
...
#convert list of vectors into plain English
...
#encrypts plaintext message (English) using secret key
#outputs list of 10-vectors 
...
def HillDecrypt(ciphertext, A, b):
    ...
    D = np.array([A_inv @ (c - b) for c in ciphertext])
...
ciphertext = [[ 797572.3932507201, -589342.47816484, 1197136.4874605502, 465544.88192278997, 582974.89571521, -122128.56482059007, -69904.49053285981, 1649630.8768264202, -1594896.80843794, 1510136.4081454298],
...
#affinekey
A = np.array([[ 0.07185715, -0.73403305, -0.9245401, 0.06831321, -0.99356369,
0.11385576, -0.1114636, 2.30909435, 0.36192622, -0.11967019],
...
0.72398736, 1.36855573, -0.20449254, 1.39638702]])


b = np.array ([ 0.88504504, 0.56591143, -1.64601525, -0.48534754, 0.47722304,
1.51061828, 0.04226098, -1.49431818, 0.82530178, -1.01940259])

decrypted_plaintext = HillDecrypt(ciphertext, A, b)
